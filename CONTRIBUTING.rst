...
Welcome to ``whereShallWeMeet`` contributor's guide.
...
If you experience bugs or general issues with ``whereShallWeMeet``, please have a look
...
You can help improve ``whereShallWeMeet`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``whereShallWeMeet`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``whereShallWeMeet``'s files. While this mechanism can
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/whereShallWeMeet.git
    cd whereShallWeMeet
...
#. Install |pre-commit|_::
   ...
   ``whereShallWeMeet`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/whereShallWeMeet
.. _issue tracker: https://github.com/<USERNAME>/whereShallWeMeet/issues
.. <-- end -->
